...
exports.handler=async function(event){
 ...
 if(body.action==='update-fulfilment'){
  ...
  const tracking=body.tracking&&typeof body.tracking==='object'?{carrier:normalizaTexto(body.tracking.carrier,80),code:normalizaTexto(body.tracking.code,120),url:normalizaTexto(body.tracking.url,500)}:(rec.tracking||null);
