...
exports.handler=async function(event){
 ...
 const secretKey=(await siteConfig.paymentRuntime().catch(()=>({}))).secret||process.env.REDSYS_SECRET_KEY;if(!secretKey){console.error('[Redsys-notify] Falta clave Redsys');return{statusCode:500,headers:HEADERS,body:'Server misconfigured'}}
