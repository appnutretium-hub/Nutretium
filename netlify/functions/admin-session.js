...
exports.handler=async function(event){
 ...
 if(body.action==='status'){
  ...
  return json(200,{ok:true,email:verified.email,role:current.member.role,permisos:[...current.permissions],csrf:verified.claims.csrf||null,expiresAt:verified.claims.exp||null});
 }
