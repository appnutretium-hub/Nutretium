...
t('solo publica GTIN desde contenido aprobado',()=>{
 const approved=feed.renderItem(base,{status:'approved',ean:'1234567890123',description:'Descripción aprobada'});
 const draft=feed.renderItem(base,{status:'draft',ean:'1234567890123'});
 assert(approved.includes('<g:gtin>1234567890123</g:gtin>'));
 assert(!draft.includes('<g:gtin>'));
});
