...
const scripts = [
  'trust-fixes.js','commerce-pro.js','final-hardening.js','commerce-suite.js','commercial-finish.js','compare-suite.js','pro-qa-fixes.js','production-finish.js','mobile-commerce-pro.js','runtime-content.js','runtime-guard.js',
];
...
console.log(`[trust-inject] capas de comercio + contenido editable + runtime guard inyectadas · sitemap ${urls.size} URLs`);
