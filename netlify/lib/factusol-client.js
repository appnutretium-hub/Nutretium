...
const DEFAULT_BASE_URL = 'https://api.sdelsol.com';
const LOGIN_PATH = '/login/Autenticar';
const QUERY_PATH = '/admin/LanzarConsulta';
const UPDATE_PATH = '/admin/ActualizarRegistro';
const DEFAULT_TIMEOUT_MS = 8000;
const WRITE_TABLES = new Set(['F_CLI', 'F_DIR', 'F_PCL', 'F_LPC']);
