...
['commercial-finish.js','product-education.js','compare-suite.js','comparar.js','pro-qa-fixes.js','production-finish.js','mobile-commerce-pro.js','commerce-suite.js','checkout.js','netlify/functions/checkout.js','netlify/functions/redsys-notify.js','netlify/functions/contact.js'].forEach(parse);
const points=[
...
console.log(`[audit-architecture] OK — ${points.length}/25 bloques + educación + comparador + QA móvil + SKU card binding + touch commerce + protecciones de producción`);
