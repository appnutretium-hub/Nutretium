...
function countryMatch(a,b){return String(a||'').trim().toLowerCase()===String(b||'').trim().toLowerCase()}
...
module.exports={configured,policy,quote,quoteWithPolicy,envPolicy,matchingMethod};
