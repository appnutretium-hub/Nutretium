...
exports.handler=async function(event){
 ...
 return{statusCode:200,headers:CORS,body:JSON.stringify({ready,platformReady,paymentsReady,emailReady,maintenance:checks.maintenance,environment:value('REDSYS_ENV')||'test',checks,missing,catalog:catalogAudit()})};
};