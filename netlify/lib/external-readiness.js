...
async function githubDeploymentState(env={},fetchImpl=global.fetch){
 ...
 if(!repo)return{ready:false,reason:'missing-repository',context:context||null,branch:branch||null,deployedSha:deployedSha||null};
 if(!deployedSha)return{ready:false,reason:'missing-deploy-sha',context:context||null,branch:branch||null,deployedSha:null};
