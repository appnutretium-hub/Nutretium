...
exports.handler=async function(event){
  ...
  const totalCents=promo.ok?promo.totalCents:pedido.totalCents;if(totalCents<=0)return json(400,{error:'El importe final no puede ser cero.'});
  ...
  return json(200,{...payment,summary:{subtotal:pedido.totalCents/100,discount:promo.ok?promo.discountCents/100:0,total:totalCents/100,coupon:promo.ok?promo.code:null}});
};