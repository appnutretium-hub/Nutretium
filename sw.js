/* Nutretium PWA service worker — never caches functions, checkout or authenticated APIs */
'use strict';
const CACHE='nutretium-shell-v1';
...
function sensitive(url){return url.pathname.startsWith('/.netlify/functions/')||/checkout|pago|payment|cuenta|admin|backoffice/i.test(url.pathname)}
