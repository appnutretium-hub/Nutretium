...
exports.handler = async event => {
  ...
  return response(200, {user: {id: user.id,name: user.name,surname: user.surname,email: user.email,phone: user.phone,role,token,mfa: mfaVerified,mfaRequired:requireMfa,rateLimitFallback:wait.fallback===true,expiresIn:security.STAFF_LOGIN_TTL_SECONDS}});
};
