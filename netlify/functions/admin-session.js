...
exports.handler=async function(event){
 ...
 if(body.action==='exchange'){
  ...
  const role=String(current.member?.role||''),normalizedRole=role.toLowerCase(),mfaRequired=normalizedRole==='owner'||normalizedRole==='admin'||security.staffMfaRequired()||verified.user?.mfaEnabled===true;
